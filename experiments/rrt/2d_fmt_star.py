...
from advanced_algos.motion_planning.sampling_methods.single_query import FMTStar
...
if __name__ == '__main__':
    ...
    ax.set_title('FMT* Path Planning')
    ...
    for edge in fmt_star.tree:
        if edge in fmt_star.parent and fmt_star.parent[edge] is not None:
            p1, p2 = fmt_star.parent[edge], edge
            ax.plot(
                [p1[0], p2[0]], [p1[1], p2[1]],
