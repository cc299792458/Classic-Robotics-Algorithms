...
if __name__ == '__main__':
    ...
    # Create an instance of InformedkRRTStar
    informed_rrt_star = InformedkRRTStar(
        start=start,
        goal=goal,
    ...
    ax.set_title('Informed-kRRT* Path Planning')
    ...
    # Plot the edges
    for edge in informed_rrt_star.all_edges:
        p1, p2 = edge
        ax.plot(
            [p1[0], p2[0]], [p1[1], p2[1]],
