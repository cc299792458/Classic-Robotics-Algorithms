    ...
    def plan(self):
        ...
        for _ in range(self.max_iters):
            ...
            if status_start != 'Trapped':
                ...
                x_nearest_goal = self.nearest(self.goal_tree, x_new_start, self.kd_tree_goal)
                status_connect, x_new_goal = self.extend(self.goal_tree, self.goal_parent, x_nearest_goal, x_new_start, is_goal_tree=True)
